...
const OUT = path.join(ROOT, 'screenshots', 'tablet10');
const PORT = 5176;
const BASE = `http://127.0.0.1:${PORT}/santiye_takip_15`;
const CHROME = 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe';

// 10 inc tablet: 9:16 (portre), Play Console kenar siniri 1080-7680px icinde.
...
async function main() {
  ...
  console.log('Vite baslatiliyor (offline mod, 10" tablet)...');
  await startVite();
