-- Rol hiyerarşisi düzenlemesi: PM > Şantiye Şefi > Saha Personeli
-- 1) Kullanıcı yönetimi (oluşturma, şifre sıfırlama, silme, rol/yetki güncelleme)
--    yalnızca Proje Müdürüne açılır; şantiye şefleri hesap yönetemez.
-- 2) Rapor silme yalnızca şef/PM yapabilir; saha personeli kendi raporunu silemez.
-- 3) Saha personeli rapor girişi/düzenlemesi yalnızca atandığı adada geçerlidir.
-- 4) Rol adları yeni saha personeli setine eşitlenir.

-- ============================================================
-- 1. Kullanıcı yönetimi fonksiyonlarını PM'e sınırla
-- ============================================================
...
-- ============================================================
-- 2. Kullanicilar UPDATE yalnızca PM (şefler hesap/yetki değiştiremez)
-- ============================================================
...
-- ============================================================
-- 4. Rapor girişi/düzenlemesi: saha personeli yalnızca atandığı adada
-- ============================================================
...
-- ============================================================
-- 5. Rol adları yeni saha personeli setine eşitlenir
-- ============================================================
